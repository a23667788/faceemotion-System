...
(function($) {
    ...
    $.imageSelectAreas.prototype.setInfo = function (id,label, attr, caption) {

        if (this._areas[id]) {
            this._areas[id].setInfo(label,attr,caption);
        
        }
    };
    $.imageSelectAreas.prototype.setColor = function (id,color) {
        if (this._areas[id]) {
            
            this._areas[id].setColor(color);
    ...
    $.imageSelectAreas.prototype.zoom = function () {
    ...
    $.selectAreas = function(object, options) {
        ...
        // else{
        //     var mainImageSelectAreas = $object.data("mainImageSelectAreas")
        //     mainImageSelectAreas.init(object, options);
        //     $object.data("mainImageSelectAreas", mainImageSelectAreas);
        //     $object.trigger("loaded");
        // }
